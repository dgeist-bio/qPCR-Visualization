...
from qPCR_visualizer import plot_delta_ct_with_colormap, plot_fold_change_with_colormap
...
class qPCRAnalyzerApp(ctk.CTk):
    def __init__(self):
        ...
        self.title("qPCR Analysis Suite v1.0")
...
"""
    ...
    def visualize_cycles(self):
        ...
        try:
            ...
            plt.colorbar(scatter, ax=ax4, label='Sample')
